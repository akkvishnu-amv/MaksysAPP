...
public class Change_Pin_Engineer extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View rootView =  inflater.inflate(R.layout.fragment_change_pin_engineer, container, false);
        btnConfirm=rootView.findViewById(R.id.btn_engineer_confirm_pin);
        currentpin=rootView.findViewById(R.id.et_engineer_old_pin);
        newpin=rootView.findViewById(R.id.et_engineer_new_pin);
        confirmpin=rootView.findViewById(R.id.et_engineer_confirm_pin);
    ...
    private void change(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.ChangePinEngineer,
